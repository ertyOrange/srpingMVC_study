...
<body>
    ...
    <form name="userForm1" action="${pageContext.request.contextPath}/file/upload" enctype="multipart/form-data" method="post">
		<div id="newUpload1">
 	...
 	<form name="userForm2" action="${pageContext.request.contextPath}/file/upload2" enctype="multipart/form-data" method="post"">
 		<div id="newUpload2">
			<input type="file" name="file">
		</div>
